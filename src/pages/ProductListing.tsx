...
import { ChevronRight, SlidersHorizontal, ArrowUpDown, LayoutGrid, List, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1280px] mx-auto px-6 pt-6 pb-16">
        ...
        <div className="flex items-center gap-3 mb-8">
          {CatIcon && <CatIcon className="w-7 h-7 text-primary" strokeWidth={1.5} />}
          <div>
            <h1 className="text-2xl font-extrabold">{catLabel}</h1>
        ...
        <div className="flex gap-6">
          {/* Sidebar Filters */}
          {showFilters && (
            <aside className="w-56 flex-shrink-0 space-y-6 hidden lg:block">
              {/* Price Range */}
              <div>
          ...
          <div className="flex-1">
            ...
            {isLoading ? (
              ...
              <div className={`grid gap-6 ${showFilters ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4"}`}>
                {filtered.map((p) => (
